...
/**
 * Validation for Currency Input Plugin
 *
 ...
 * @param {String|Bool} input.all.currency - value of input currency
 ...
 * @param {Object} [settings.all.currency] - settings of input currency {Object}
 *
...
module.exports = function currencyValidation() {
  return true;
};
